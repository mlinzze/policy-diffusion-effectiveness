...
* SECTORAL POLICIES ONLY (all policies and RENEWABLE + ENERGY POLICIES  done separately)
* KEY CHANGE IS MADE IN LINE 33 (solar vs hydro vs wind)


set more 1

use "U:\SAM Publications\Climate Policy Diffusion\total electricity capacity by source.dta", clear
...
save "U:\SAM Publications\Climate Policy Diffusion\total electricity capacity by source_expanded.dta", replace 
...
sort state year
drop if year<1991
merge m:m state year using "U:\SAM Publications\Climate Policy Diffusion\total electricity capacity by source_expanded.dta"
